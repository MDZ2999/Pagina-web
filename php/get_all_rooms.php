...
$sql = "SELECT id_cuarto, id_usuario, titulo, servicios, disponibilidad, imagen, imagen2, imagen3, imagen4 FROM cuartos WHERE disponibilidad = 1 ORDER BY titulo ASC";
